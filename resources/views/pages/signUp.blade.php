  ...
  <div class="signup-container">
    ...
    <div class="signup-left">
      ...
      <div class="mobile-header">
        ...
        <img src="{{asset('images/unnamed2.png')}}" alt="Cat" class="mobile-cat">
      ...
      <div class="signup-content">
        ...
        @if($errors->any())
          <div class="alert alert-danger" style="padding: 12px 16px; background: #f8d7da; color: #721c24; border-radius: 8px; margin-bottom: 20px; border-left: 4px solid #dc3545; max-width: 500px;">
        ...
        <form method="POST" action="{{ route('signup') }}" enctype="multipart/form-data" id="signupForm">
          @csrf
          ...
          <div class="form-step active" id="stepRole">
            ...
            <p class="signup-subtitle">
              ...
              You can <a href="{{ route('login') }}" class="signin-link">Sign In here !</a>
            </p>
            ...
            <div class="role-selection">
              ...
              <div class="role-options">
                <!-- Normal User -->
                <div class="role-card {{ old('role') == 'normal' ? 'active' : '' }}" data-role="normal">
                  <div class="role-icon">
                ...
                <!-- Pet Sitter -->
                <div class="role-card {{ old('role') == 'sitter' ? 'active' : '' }}" data-role="sitter">
                  <div class="role-icon">
          ...
          <div class="form-step" id="stepPhoto">
            ...
            <button type="submit" class="btn-submit" id="btnSubmit" disabled>Sign Up</button>
          </div>
          ...
          <div class="form-step" id="stepFinish">
            ...
            <button type="submit" class="btn-submit" id="btnSubmitNormal">Sign Up</button>
          </div>
        </form>
      </div>
    </div>
